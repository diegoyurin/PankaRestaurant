<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pedido.aspx.cs" Inherits="Front_end.Pedido" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Panka Restaurant - Pedido</title>
...
<body>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/fondo.jpg)" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font">¡Está cerca de realizar un pedido!</h1>	
						</div>
					</div>
				</div>
			</div>
	...
	<div class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
                <asp:GridView ID="gvPedido" runat="server" AutoGenerateColumns="false" HorizontalAlign="Center"
                    CssClass="table table-bordered">
                    <Columns>
                        <asp:BoundField DataField="IdReceta" HeaderText="ID" />
                        ...
                        <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:TextBox ID="IDcantidad" runat="server" Text="0" type="number" min="0" step="1"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>

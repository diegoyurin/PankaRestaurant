<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Front_end.Menu" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Panka Restaurant - Menú</title>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<li class="active"><a href="menu.aspx">Menú</a></li>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font">¡Pruebe nuestro menú!</h1>	
						</div>
					</div>
				</div>
			</div>
		...
		<div class="gtco-container">
            ...
            <div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					...
					<asp:button runat="server" text = "Click aquí" id="btnPedido" OnClick="btnPedido_Click"/>
				</div>
			</div>
		</div>
	</div>
